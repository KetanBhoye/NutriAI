...
Rules:
- Base the calorie target on their maintenance (TDEE). A cut is roughly a 15–25% deficit; a lean bulk a 5–10% surplus; a bulk a 10–20% surplus; maintenance stays near TDEE. Never go below their BMR for calories.
